...
/**
 * Created by Nikolay Unuchek on 21.01.2016.
 */
public class TextDrawable extends ShapeDrawable {
    ...
    public interface IConfigBuilder {
        ...
        IConfigBuilder withBorder(int thickness, int borderColor);

        IConfigBuilder withBorder(int thickness, String borderColor);
